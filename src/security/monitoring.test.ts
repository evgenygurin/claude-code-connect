...
import { SecurityAgent, SecurityEventType, SecuritySeverity } from "./security-agent.js";
...
describe("SecurityMonitor", () => {
  ...
  describe("instantiation", () => {
    it("should create instance with default options", () => {
      const monitor = new SecurityMonitor(testEnv.config, testEnv.logger, securityAgent);
